...
void Scene::initModels()
{
    ...
    loadedModeles["models/bishop.obj"] = Vao::loadObj("models/fou.obj", glm::vec3(1.0));
    loadedModeles["models/king.obj"] = Vao::loadObj("models/roi.obj", glm::vec3(1.0));
    loadedModeles["models/knight.obj"] = Vao::loadObj("models/cavalier.obj", glm::vec3(1.0));
    loadedModeles["models/pawn.obj"] = Vao::loadObj("models/pion.obj", glm::vec3(1.0));
    loadedModeles["models/queen.obj"] = Vao::loadObj("models/dame.obj", glm::vec3(1.0));
    loadedModeles["models/rook.obj"] = Vao::loadObj("models/tour.obj", glm::vec3(1.0));
